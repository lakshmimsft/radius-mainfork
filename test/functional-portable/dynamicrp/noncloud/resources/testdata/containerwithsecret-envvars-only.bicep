...
var keyVaultId = '/subscriptions/bb48e769-817e-4890-ab84-db911c92c791/resourceGroups/lak-azrg/providers/Microsoft.KeyVault/vaults/lak-azure-secret-env4'
var keyVaultSecretNames = ['username', 'password', 'apikey']

// USE CASE 1: Environment Variables Only (No CSI Driver, No Volume Mount)
...
// Deployment with secret environment variables
